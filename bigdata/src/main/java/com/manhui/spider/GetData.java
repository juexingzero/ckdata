...
public class GetData {
	...
	public static JSONObject getTaoBaoData(Integer currentPage) {
		String[] param={TaobaoConstant.SEARCH, TaobaoConstant.PARAM+(currentPage*20), TaobaoConstant.COOKIE};
	...
	public static String getCommodity(String shopUrl,Integer currentPage){
		String[] param={shopUrl+TaobaoConstant.COMMODITY_ALL, TaobaoConstant.COMMODITY_PAEAM+currentPage, TaobaoConstant.COMMODITY_COOKIE};
		String html=HttpRequest.sendGet(param);
